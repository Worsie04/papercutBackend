...
module.exports = {
  async up(queryInterface, Sequelize) {
    try {
      ...
      // Delete old migration records if they exist
      await queryInterface.sequelize.query(`
        DELETE FROM "SequelizeMeta" 
        WHERE name IN (
          '20240219000011-create-record-versions.js',
          '20250213000001-create-record-versions.js',
          '20250213214515-create-record-versions.js'
        );
      `);
